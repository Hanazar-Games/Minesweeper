...
const Achievements = (function() {
    const ACHIEVEMENTS = [
        ...
        { id: 'zen_perfect', name: '禅心通明', desc: '禅意模式零失误完成', icon: '☯️', category: 'challenge', condition: (s, g) => g.won && g.challengeMode === 'zen' && g.zenMistakes === 0 },
        { id: 'zen_gardener', name: '园艺大师', desc: '在禅意花园种下10朵花', icon: '🌺', category: 'challenge', condition: () => typeof ZenMode !== 'undefined' && ZenMode.getStats && ZenMode.getStats().totalCompletions >= 10 },
        { id: 'zen_meditation_hour', name: '入定一小时', desc: '禅意模式累计冥想60分钟', icon: '🕯️', category: 'challenge', condition: () => typeof ZenMode !== 'undefined' && ZenMode.getStats && ZenMode.getStats().totalMeditationTime >= 3600 },
